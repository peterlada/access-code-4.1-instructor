...
1. Download the [`Unit 3 Midterm.postman_collection.json`](unit_3_midterm.postman_collection.json?raw=true) file.
...
![add environent screenshot](screenshots/add_environment.png?raw=true)
...
![add environent screenshot](screenshots/manage_environment.png?raw=true)
...
![add environent screenshot](screenshots/test_tab.png?raw=true)

* The test results can be seen by clicking on the `Test Results` tab to the right of the `Body` tab.

![add environent screenshot](screenshots/test_results.png?raw=true)